...
if(isset($_POST['LOGIN_BUTTON'])){
	...
	$query=mysqli_query($db_connect,"select * from adminlogin_tb where a_email='$EMAIL' and a_password='$PASS' ");
	$checkpoint=$query->num_rows;
	if ($checkpoint==1) {

		$data=mysqli_fetch_array($query);
		$_SESSION['a_login_id']=$data['a_login_id']; 
...
<body>
	<div class="mb-3 mt-5 container text-center" style="font-size: 30px;">
		...
		<p class="text-center" style="font-size: 20px;">
			<i class="fas fa-user-secret text-danger mr-2 "></i>Admin Login Area
		</p>
